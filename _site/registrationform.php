<?php
$my_email = "registration@tannconference.com";
$errors = array();
...
Thank you for registering for TANN 2018. If you have requested any official letters, please allow up to 5 business days to receive your documents.

If you are an author, please make sure to send us your camera ready version and a signed copyright form via email to info@tannconference.com. You can find the copyright form here: www.tannconference.com/papers. Please note that failing to do so may result in an unsuccessful process of your registration.

You can find your registration details below. If there are any errors in the information you have provided, please write an email to us at registration@tannconference.com mentioning the correct information. Please note that you SHOULD NOT refill the form.
...
<script>
  (function() {
    var cx = '016656741306535874023:ngwbsl3lfcs';
    ...
    <div class="unit unit-s-3-4 unit-m-1-3 unit-l-1-3">
      ...
      <div class="unit unit-s-1-3 unit-m-2-3 unit-m-2-3-1 unit-l-2-3">
        ...
        <div class="bg">
          ...
          <p class="subhead">June 7 - 9, 2018 | Toronto, Canada</p>
 ...
 <div class="unit unit-s-3-4 unit-m-3-4 unit-l-3-4">
  ...
  <div class="unit unit-s-1 unit-m-1-3-1 unit-l-1-3-1">
    ...
    <div>
      ...
      <p class="body">TANN 2018 will  be held in Toronto, Canada on June 7 - 9, 2018.</p>

      <!-- <p class="bold">TANN'18 Workshop</p>
      <p class="body">As per popular request, the organizing committee has decided to extend the TANN'18 conference to three days (now June 7 - 9, 2018). The new high-level schedule is as follows:</p>
...
<form action="../contactus.php" method="post" enctype="multipart/form-data" name="ContactForm" class="cf">
  ...
  <center class="full right cf"><div class="g-recaptcha" data-sitekey="6LdPFyMTAAAAAPIz9sq9lTaKFIrSrdmfbXWkaSZP"></div></center>
  <div class="cf">
